//
//  ReportCarsViewController.swift
//  MileageTracker
//
...
class ReportCarsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Beacon.queryOffline()?.findObjectsInBackground(block: { (beacons, error) in
            if error == nil{
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        (segue.destination as! MonthsViewController).dates = selectedDates
        (segue.destination as! MonthsViewController).car = cars[selectedPosition]
    }
